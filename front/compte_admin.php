...
<div class="container">
    <div class="row">
        <div class="col-md-4 mt-4">
            ...
            <form method="post" action="back/compte_data.php">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        if ($firstRow) {
                            $firstRow = false;
                            continue; // Saute la première ligne
                        }
                        echo "<tr>";
                        echo "<td class='username'>" . $row['username'] . "</td>";
                        echo "<td class='nom'>" . $row['nom'] . "</td>";
...
<style>
    .modal-content {
        background-color: rgb(78, 181, 78);
    }
    /* Définir la couleur du texte en noir pour les champs du modèle modal */
