        ...
        <div class="d-flex flex-column align-items-center" style='border-radius: 10px; border: 3px solid black; margin:10px; background-color:white'>
            <div class="col-md-15">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="compte.php" class="btn btn-warning custom-btn">Créer un compte</a>
                    <img src="front/img/utilisateur.gif" width="100" height="100" alt="GIF utilisateur">
                </div>
            </div>
            <div class="col-md-8">
...
<div class="col-md-4" style="height: 200px; width:500px; margin: 10px;">
    <div class="row justify-content-center">
        <div class="d-flex flex-column align-items-center" style='border-radius: 10px; border: 3px solid black; margin:10px; background-color:white'>
            <div class="col-md-15">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="les_habitats_gestion.php" class="btn btn-warning custom-btn">Gestion des habitats</a>
                    <img src="front/img/habitat.gif" width="100" height="100" alt="GIF utilisateur">
                </div>
            </div>
            <div class="col-md-8">
...
<div class="col-md-4" style="height: 200px; width:500px; margin: 10px;">
    <div class="row justify-content-center">
        <div class="d-flex flex-column align-items-center" style='border-radius: 10px; border: 3px solid black; margin:10px; background-color:white'>
            <div class="col-md-15">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="avis_gestion.php" class="btn btn-warning custom-btn">Gestion des avis</a>
                    <img src="front/img/avis.gif" width="100" height="100" alt="GIF utilisateur">
                </div>
            </div>
            <div class="col-md-8">
...
<div class="col-md-4" style="height: 200px; width:500px; margin: 10px;">
    <div class="row justify-content-center">
        <div class="d-flex flex-column align-items-center" style='border-radius: 10px; border: 3px solid black; margin:10px; background-color:white'>
            <div class="col-md-15">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="animal_gestion.php" class="btn btn-warning custom-btn">Gestion des animaux</a>
                    <img src="front/img/animaux.gif" width="100" height="100" alt="GIF utilisateur">
                </div>
            </div>
            <div class="col-md-8">
...
<div class="col-md-4" style="height: 200px; width:500px; margin: 10px;">
    <div class="row justify-content-center">
        <div class="d-flex flex-column align-items-center" style='border-radius: 10px; border: 3px solid black; margin:10px; background-color:white'>
            <div class="col-md-15">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="employe_gestion.php" class="btn btn-warning custom-btn">Alimentation quotidienne</a>
                    <img src="front/img/alimentation.gif" width="100" height="100" alt="GIF utilisateur">
                </div>
            </div>
            <div class="col-md-8">
...
<div class="col-md-4" style="height: 200px; width:500px; margin: 10px;">
    <div class="row justify-content-center">
        <div class="d-flex flex-column align-items-center" style='border-radius: 10px; border: 3px solid black; margin:10px; background-color:white'>
            <div class="col-md-15">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="stat_dashboard.php" class="btn btn-warning custom-btn">Nombre de consultations</a>
                    <img src="front/img/stat.gif" width="100" height="100" alt="GIF utilisateur">
                </div>
            </div>
            <div class="col-md-8">
