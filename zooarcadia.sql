...
INSERT INTO zooarcadia.service (description, nom) VALUES 
('Profitez de délicieuses options culinaires qui raviront vos papilles tout en vous offrant l''énergie nécessaire pour explorer le zoo.', 'Restauration'),
('Plongez dans le monde fascinant de nos habitants à fourrure, à plumes et à écailles avec nos visites guidées gratuites. Nos guides expérimentés vous emmèneront à travers les habitats pour vous permettre de découvrir les secrets de chaque espèce.', 'Visite des habitats avec un guide (gratuit)'),
('Montez à bord de notre petit train et laissez-vous transporter à travers les merveilles du zoo. Profitez d''une expérience panoramique relaxante tout en explorant les différents habitats et en observant nos animaux dans leur environnement naturel.', 'Visite du zoo en petit train');
